...
* 🟢 [entt](https://github.com/skypjack/entt) ⭐ 13,116 | 🐛 12 | 🌐 C++ | 📅 2026-09-17 - Fast and reliable entity-component system. [⭐ 12.8k](https://github.com/skypjack/entt) ⭐ 13,116 | 🐛 12 | 🌐 C++ | 📅 2026-09-17
* 🟢 [Flecs](https://github.com/SanderMertens/flecs) ⭐ 8,673 | 🐛 56 | 🌐 C | 📅 2026-09-17 - A Multithreaded Entity Component System written for C89 & C99. [⭐ 8.4k](https://github.com/SanderMertens/flecs) ⭐ 8,673 | 🐛 56 | 🌐 C | 📅 2026-09-17
* 🟢 [WickedEngine's ECS](https://github.com/turanszkij/WickedEngine/blob/master/WickedEngine/wiECS.h) ⭐ 7,232 | 🐛 115 | 🌐 C++ | 📅 2026-09-17 - WickedEngine's ECS implementation. [⭐ 7.1k](https://github.com/turanszkij/WickedEngine) ⭐ 7,232 | 🐛 115 | 🌐 C++ | 📅 2026-09-17
...
* 🟢 [ME.BECS](https://github.com/chromealex/ME.BECS) ⭐ 257 | 🐛 1 | 🌐 C# | 📅 2026-09-17 - ECS for Unity with full game state automatic rollbacks. [⭐ 249](https://github.com/chromealex/ME.BECS) ⭐ 257 | 🐛 1 | 🌐 C# | 📅 2026-09-17
...
* 🟢 [bevy\_ecs](https://github.com/bevyengine/bevy/tree/main/crates/bevy_ecs) ⭐ 48,239 | 🐛 3,414 | 🌐 Rust | 📅 2026-09-17 - Simple to use, ergonomic, fast, massively parallel, opinionated, and featureful written in Rust. [⭐ 46.8k](https://github.com/bevyengine/bevy) ⭐ 48,239 | 🐛 3,414 | 🌐 Rust | 📅 2026-09-17
...
* 🟢 [WickedEngine](https://github.com/turanszkij/WickedEngine) ⭐ 7,232 | 🐛 115 | 🌐 C++ | 📅 2026-09-17 - 3D engine with modern graphics. [⭐ 7.1k](https://github.com/turanszkij/WickedEngine) ⭐ 7,232 | 🐛 115 | 🌐 C++ | 📅 2026-09-17
* 🟢 [halley](https://github.com/amzeratul/halley) ⭐ 3,857 | 🐛 47 | 🌐 C | 📅 2026-09-17 - A lightweight game engine written in modern C++. [⭐ 3.8k](https://github.com/amzeratul/halley) ⭐ 3,857 | 🐛 47 | 🌐 C | 📅 2026-09-17
...
* 🟢 [nebula](https://github.com/gscept/nebula) ⭐ 1,095 | 🐛 34 | 🌐 C++ | 📅 2026-09-17 - Open-source and free-to-use modern C++ game engine. [⭐ 1.1k](https://github.com/gscept/nebula) ⭐ 1,095 | 🐛 34 | 🌐 C++ | 📅 2026-09-17
...
* 🟢 [supernova](https://github.com/supernovaengine/supernova) ⭐ 837 | 🐛 13 | 🌐 C++ | 📅 2026-09-17 - Game engine for 2D and 3D projects with ECS and data-oriented design. [⭐ 420](https://github.com/supernovaengine/supernova) ⭐ 837 | 🐛 13 | 🌐 C++ | 📅 2026-09-17
...
* 🟢 [Bevy](https://github.com/bevyengine/bevy) ⭐ 48,239 | 🐛 3,414 | 🌐 Rust | 📅 2026-09-17 - A refreshingly simple data-driven game engine built in Rust. [⭐ 46.8k](https://github.com/bevyengine/bevy) ⭐ 48,239 | 🐛 3,414 | 🌐 Rust | 📅 2026-09-17
...
* 🟢 [bs::framework](https://github.com/GameFoundry/bsf) ⭐ 1,925 | 🐛 3 | 🌐 C++ | 📅 2026-09-17 - Modern C++14 library for the development of real-time graphical applications. [⭐ 1.9k](https://github.com/GameFoundry/bsf) ⭐ 1,925 | 🐛 3 | 🌐 C++ | 📅 2026-09-17
